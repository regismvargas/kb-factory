...
def test_vnext_packages_are_separate_and_do_not_collide(tmp_path: Path) -> None:
    ...
    assert names == {
        "kb-wiki-vnext-plugin-0.1.8.zip",
        "kb-wiki-vnext-claude-plugin-0.1.8.zip",
        "kb-wiki-vnext-cowork-plugin-0.1.8.zip",
    }
    ...
    for artifact in artifacts:
        ...
        with ZipFile(artifact.archive_path, "r") as archive:
            ...
            if artifact.archive_path.name == "kb-wiki-vnext-plugin-0.1.8.zip":
