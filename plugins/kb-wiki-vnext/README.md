...
|---|---|---|
| `kb-wiki-vnext-plugin-0.1.3.zip` | `.codex-plugin/plugin.json` plus `.claude-plugin/plugin.json` | `AGENTS.md`, `skills/`, `commands/`, `hooks/` |
| `kb-wiki-vnext-claude-plugin-0.1.3.zip` | `.claude-plugin/plugin.json` | `AGENTS.md`, `skills/`, `commands/`, `hooks/` |
| `kb-wiki-vnext-cowork-plugin-0.1.3.zip` | `.claude-plugin/plugin.json` | `AGENTS.md`, `skills/`, `commands/`, `hooks/` |
